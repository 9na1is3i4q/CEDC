...
import distributed.result.annotations.CycleLength;
import distributed.result.annotations.CycleOffset;
...
public class Result {
    ...
    protected Map<Integer,int[]> agentData;
    ...
    public HashMap<Integer, int[]> disNeighbourMap;
    public int maxDistance;
    public int[] users;
    public HashMap<Integer,int[]> userRequireData;
    ...
    public Result(){
        ...
        disNeighbourMap = new HashMap<>();
        userRequireData = new HashMap<>();
    ...
    public void setAgentData(int agentId, int[] data) {
        int[] datatmp = new int[data.length];
        System.arraycopy(data, 0, datatmp, 0, data.length);
        agentData.put(agentId,datatmp);
    }

    public int[] getAgentData(int agentId){
    ...
    public void setDisNeighbour(Map<Integer, int[]> neighboursUnderLimit) {
       disNeighbourMap = new HashMap<>(neighboursUnderLimit);
    }

    public void setUsers(int[] users) {
        int[] user = new int[users.length];
        System.arraycopy(users, 0, user, 0, user.length);
        this.users = user;
    }

    public void setUserRequireData(Map<Integer,int[]> userRequireData) {
        this.userRequireData = new HashMap<>(userRequireData);
    }
