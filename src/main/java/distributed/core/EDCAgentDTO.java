...
@Data
public class EDCAgentDTO {
    public EDCAgentDTO(int id, int[] data, int[] divices, Set<Integer> relatedUsers, int[] neighbours, Map<Integer, int[]> neighboursUnderLimit, Map<Integer, int[]> userRequireData, Map<Integer, int[]> userHosts, Map<Integer, Integer> neighboursAdject, Map<Integer, int[]> neighbourHostUsers, int serverDataLimit, int maxDistance) {
        this.id = id;
        this.data = data;
    ...
    private  Map<Integer,int[]> userRequireData;
